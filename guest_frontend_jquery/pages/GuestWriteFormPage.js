...
export const GuestWriteFormPage = () => {
    const guestWriteAction = async () => {
        ...
        const resultJsonObject = await guestAPI.writeFormGuest(sendJsonObject);
            ...
            <tr>
                <td>
                    ...
                    <table width="590" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td align="center"><input type="button" value="방명록쓰기" id="btn_guest_write_action"> &nbsp; <input type="button" data-navigate='#/guest_list' id="btn_guest_list_btn" value="방명록목록"></td>
                            </tr>
                        </tbody>
                    </table>
                </td>
