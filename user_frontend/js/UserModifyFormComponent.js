...
export const UserModifyFormComponent = async (userId) => {
  const userModifyAction = async () => {
    ...
    const responseJsonObject = await modifyUser(sendJsonObject, userId);
    location.hash = `#/user/${userId}`;
  };

  const responseJsonObject = await modifyFormUser(userId);
  const template = `
                        ...
                        <table border="0" cellpadding="0" cellspacing="1" width="590"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width="490" bgcolor="ffffff" style="padding-left: 10px"
                                        align="left"><input type="text" style="width: 150px"
                                        name="email" value="guard1@korea.com"></td>
                                </tr>
                            </tbody>
                        </table>
                    </form> <br>
